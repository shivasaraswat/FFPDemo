...
const RoleHeader = ({ role }) => {
  return (
    <th className="px-4 py-4 bg-bg-secondary border-b border-gray-200 text-center">
      <div className="flex flex-col gap-3 items-center">
        <span className="font-semibold text-xs text-gray-700 uppercase tracking-wider text-center" title={role.name}>
